...
class Piece_Bishop extends Piece {

    public Piece_Bishop(String name, Team team, Position position) {
        super(name, team, position, false, team == Team.BLACK ? "/images/Black_Bishop.png" : "/images/White_Bishop.png");
    }
