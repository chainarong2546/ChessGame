...
class Piece_Rook extends Piece {

    public Piece_Rook(String name, Team team, Position position) {
        super(name, team, position, false, team == Team.BLACK ? "/images/Black_Rook.png" : "/images/White_Rook.png");
    }
